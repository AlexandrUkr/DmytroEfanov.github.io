    ...
    $.fn.freshslider = function(options){
        ...
        if(range){
            view = this.html("<div class='fsslider'><div class='fsfull-value'></div>" +
                "<div class='fssel-value'></div><div class=' fss-left'><div class='fscaret'></div></div>" +
                "<div class='fscaret fss-right'><div class='fscaret'></div></div></div>").find('.fsslider');
        }
        else{
            view = this.html("<div class='fsslider'><div class='fsfull-value'></div>" +
                "<div class='fssel-value'></div><div><div class='fscaret'></div></div></div>")
                .find('.fsslider');
        }
